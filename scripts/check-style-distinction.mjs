...
const delegatedSampleSources = {
  ...
  NaturalFibreIndex: "../src/components/design-style/FlaxProvenance.tsx",
...
const requiredFamilyMarkers = {
  ...
  natural: ["Undyed", "material index", "material record", "provenance chain", "the colour is the fibre"],
