...
const PROMPTS = {
  "ai-aesthetic":
    "A luminous generative-AI world-model render, no people and no text. A vast dreamlike bioluminescent atrium made of flowing liquid-glass architecture: soft translucent ribbed arches curve upward into a hazy violet sky, glowing spore-like particles drift through volumetric fog, a still reflective pool of light on the floor doubles the glow. The surfaces feel computationally smooth and impossibly soft, gradients bleeding into one another the way a diffusion model renders light, with gentle chromatic fringing at the edges of forms. Palette: deep indigo-black ground, luminous violet, electric cyan, soft magenta-pink accents, near-white highlights. Cinematic wide composition, shallow depth of field, soft volumetric glow, high production render quality. No text, no letters, no numbers, no logos, no watermark, no people, no UI, no readable interface.",
  maximalism:
