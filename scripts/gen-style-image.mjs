...
const PROMPTS = {
  chromecore:
    "A bright 2003 consumer-electronics catalog photograph of five Y2K mobile-phone snap-on faceplate shells laid out in a neat evenly-spaced row on a clean white studio surface, no people and no text. Each shell is a molded, rounded, palm-sized front cover with softly curved edges, a small blue-tinted lens window and a keypad cutout; each has a different finish, from left to right: mirror-polished chrome, brushed silver, dark gunmetal, pearl white, deep cobalt blue metallic. Crisp bright studio lighting with strong specular highlights and tiny star-shaped flashes glinting on the polished edges, soft clean reflections on the white surface beneath each shell, shallow depth of field. Realistic high-quality early-2000s product catalog photography, wide composition, optimistic, clean and shiny. Palette: mirror chrome silver, cool white, gunmetal grey, pearl, cobalt blue. No text, no letters, no numbers, no logos, no watermark, no people, no UI, no brand marks, no dark background.",
  "ai-aesthetic":
