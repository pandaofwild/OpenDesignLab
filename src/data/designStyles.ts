...
const styleMoodboards: Partial<Record<string, StyleMoodboard>> = {
  ...
  "hologram-style": {
    alt: "Bright clinical optics moodboard with non-gory anatomical scans, translucent slice film, cyan-violet diffraction sheets, clear acrylic blocks, grid vellum, and layered volume studies.",
    caption: "Clinical light field: build depth from physical scan slices, clear optics, four-plane volume studies, and restrained spectral edges rather than floating glass cards or chrome spectacle.",
    directionKeywords: ["clinical optical research board", "anatomical scan film", "four-plane volume studies", "cyan violet diffraction", "pearl laboratory materials"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/hologram-style-realistic-v2.webp",
    prompt:
      "Create a realistic editorial moodboard for Hologram Style in a professional web-design reference library, photographed directly from above on a pearl-white laboratory studio table. Arrange a curated asymmetrical flat lay of printed non-gory anatomical volume crops, translucent medical scan-film slices, cyan and violet diffraction film, one pale amber measurement acetate, clear acrylic optical plates, fine-grid vellum, small prism fragments, pearl clinical paper, cool-grey color chips, and scientific volumetric layout studies with blank bars only. Communicate clinical volumetric light fields, four-plane depth, optical slices, and scientific measurement for a medical visualization website, not glassmorphism, HUD, a high-tech dashboard, chromecore, metaverse imagery, or holographic fashion. Include tape corners, pin marks, slight paper curl, uneven crop edges, subtle dust, varied paper thickness, real refraction, and soft natural shadows; every object rests physically on the table. Palette: pearl white, icy cyan, restrained violet, cool grey, one small pale amber accent. No readable text, letters, numbers, labels, brand names, logos, watermark, fake UI gibberish, people, faces, gore, floating objects, synthetic UI collage, cyberpunk darkness, metallic chrome dominance, generic rainbow spectacle, or decorative clutter. Landscape 16:10, high-resolution realistic top-down editorial photography.",
  },
  chromecore: {
