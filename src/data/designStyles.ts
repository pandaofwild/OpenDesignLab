...
const styleMoodboards: Partial<Record<string, StyleMoodboard>> = {
  ...
  "art-nouveau": {
    alt: "Art Nouveau moodboard on parchment: cast-iron whiplash ornament fragments, leaded amber and peacock glass, layout proofs organised by one sinuous line, ink studies of stems curling back on themselves, a coiled fern crozier, sage and aubergine chips, and a peacock feather.",
    caption: "Let one asymmetric line that bends back on itself organise the page, and treat iron and glass ornament as the structure rather than as trim applied to a grid.",
    directionKeywords: ["coup de fouet whiplash", "ornament as structure", "cast iron and leaded glass", "coiled fern crozier", "peacock amber aubergine"],
    generatedWith: "imagegen",
