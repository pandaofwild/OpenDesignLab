...
const styleContentOverrides: Record<string, StyleContentOverride> = {
  ...
  "new-brutalism": {
    ...
    layoutTraits: ["셀프 키오스크 상태보드와 컨트롤 패널처럼 구성됩니다 — 머신 타일, 코스 폼, 요금표가 실제 앱처럼 놓입니다.", "각 모듈은 독립적인 박스처럼 명확하게 분리됩니다.", "모바일에서도 큰 터치 타깃과 그림자가 남아야 합니다."],
...
const styleMoodboards: Partial<Record<string, StyleMoodboard>> = {
  ...
  "hologram-style": {
    alt: "Pure holographic material moodboard with iridescent foil sheets, diffraction film, a glass prism casting a thin rainbow caustic, dichroic glass chips, layered clear acetate stacks, and spectral-gradient layout crops on a pearl-white table.",
    caption: "Pure hologram optics: build the language from real diffraction — iridescent foil, spectral prism light, dichroic cyan-violet shifts, and translucent layered depth — rather than chrome mirrors, pastel renders, or frosted glass cards.",
    directionKeywords: ["holographic foil and diffraction film", "prism spectral caustic", "dichroic cyan violet shift", "layered translucent depth", "pearl studio materials"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/hologram-style-realistic-v3.webp",
    prompt:
      "Create a realistic editorial moodboard for Hologram Style in web design, photographed directly from above on a pearl-white studio table. The board is a curated designer research board about holographic light itself: several sheets of transparent diffraction-grating film and iridescent holographic foil catching real cyan-violet-magenta spectral reflections, a small glass prism casting one thin genuine rainbow caustic across the paper, dichroic glass chips shifting between cyan and violet, a neat stack of clear layered acetate films spaced to show depth between layers, one lenticular sheet fragment, printed website layout crops with soft spectral gradient edges and blank text bars only, pearl and cool-grey paper samples, and a strip of color chips in pearl white, icy cyan, violet, cool grey, and one small pale amber chip. Communicate translucent depth, spectral diffraction, and light-field layering as a web design language — clearly distinct from mirror-chrome metal surfaces, pastel diffusion-render softness, dark neon cyberpunk, and frosted glassmorphism cards. Use real-world imperfections: slight film curl, soft natural shadows, subtle grain, tape corners, pin marks, uneven crop edges, and varied material thickness; every object rests physically on the table with real refraction and thin spectral glints. Palette: pearl white, icy cyan, violet, soft magenta glint, cool grey, one small pale amber accent. No readable text, no letters, no numbers, no labels, no brand names, no logos, no watermark, no fake UI gibberish, no people, no floating objects, no full rainbow spectacle covering the frame, no glitter chaos, no chrome dominance. Landscape 16:10, high-resolution realistic top-down editorial photography.",
  },
  chromecore: {
  ...
  neoclassic: {
    alt: "Neoclassic moodboard on cool grey stone: copperplate engravings of the orders, a squared setting-out sheet with a pencil elevation, brass dividers and a boxwood scale rule, an egg-and-dart plaster cast, a jasper blue medallion, basalt and Pompeian red fragments, and celadon chips.",
    caption: "Draw rather than decorate: line over colour, measurement over invention, and ruled equal fields on one baseline instead of luxury surface.",
    directionKeywords: ["line over colour","measured not invented","dividers and scale rule","jasper blue and Pompeian red","plate marks and foxing"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/neoclassic.webp",
    prompt:
  ...
  "art-nouveau": {
    alt: "Art Nouveau moodboard on cream: a whiplash line drawing, cast-iron ornament with curling stems, a patinated bronze curl, leaded amber and faded teal glass, a coiled fern crozier, a muted iris and lily lithograph, dusty rose and sage chips, and a peacock feather.",
    caption: "Let one asymmetric line that bends back on itself organise the page, keep every colour at aged poster strength, and treat iron and glass ornament as the structure rather than as trim.",
    directionKeywords: ["coup de fouet whiplash","ornament as structure","cast iron and leaded glass","coiled fern crozier","muted poster ink"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/art-nouveau.webp",
    prompt:
  ...
  baroque: {
    alt: "Baroque moodboard lit by one warm raking light on a near-black table: scrollwork and cartouche ornament studies, a gilded frame corner, crimson velvet and gold brocade, verdigris green cloth, gold leaf, walnut, marble, and a horseshoe auditorium plan.",
    caption: "Tenebrism first: hold most of the surface in near-black, let one warm source pick out the lit cluster, and build hierarchy from curved scrollwork rather than from rectangular borders.",
    directionKeywords: ["single raking light", "near-black ground", "curved scrollwork and cartouche", "crimson velvet and true gilt", "ceremonial venue plan"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/baroque.webp",
    prompt:
  ...
  rococo: {
    alt: "Rococo moodboard on an ivory bench, composed deliberately off-balance: a carved limewood rocaille offcut half water-gilded, a book of gold leaf, a tip brush and agate burnisher, a dish of red bole, asymmetric scroll drawings, and pale rose, vert d'eau and sky blue paint-outs.",
    caption: "Compose off-balance — contraste means no half repeats the other — and let warm matte gilding hold pale fields rather than filling them.",
    directionKeywords: ["contraste off-balance","carved rocaille half-gilded","water gilding kit","pale rose vert d'eau bleu","ivory limewood bench"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/rococo.webp",
    prompt:
  ...
  gothic: {
    alt: "Gothic moodboard on cool limestone: leaded glass offcuts in cobalt, ruby, emerald and gold lit from beneath, a coil of lead came, tracery and rib-vault setting-out drawings, a carved limestone boss with stone dust, a steel square and dividers, and lancet layout proofs.",
    caption: "Make the glass the brightest thing on the page and keep the stone cool: build hierarchy from pointed arch, rib and tracery carrying load, with lancet proportion in place of a grid.",
    directionKeywords: ["glass brightest on cool stone","wall opened for light","tracery and rib setting-out","lancet columns not a grid","lead came and stone dust"],
    generatedWith: "imagegen",
    imageSrc: "/generated/moodboards/gothic.webp",
    prompt:
